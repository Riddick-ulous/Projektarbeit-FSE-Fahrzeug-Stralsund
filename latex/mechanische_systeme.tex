...
\begin{figure}[h]
	...
	\caption{}
	\label{fig:elwleistung-uber-volumenstrom \cite{DatenblattELW}}
\end{figure}
...
\begin{figure}[h]
	...
	\caption{}
	\label{fig:elw-druckabfall-uber-volumenstrom \cite{DatenblattELW}}
\end{figure}
...
\\
Für den Umrichter gibt es im Datenblatt \cite{manual HV-500} ein fertiges Diagramm, siehe \ref{fig:cooling-characteristik}.
\begin{figure}[h]
	\centering
