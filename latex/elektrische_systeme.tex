...
\begin{table}[h]
	...
	\begin{tabular}{|c|c|c|}
		...
		\hline
		\glsc{symb:I_Ripple} & 4 & \ensuremath{A}  \\
		\hline
		...
		\multicolumn{3}{|c|}{Ergebnisse} \\
		\hline
		\glsc{symb:L_O}1 & 47,44 & \ensuremath{uH} \\
		\hline
		\glsc{symb:C_O}1 & 21,4 & \ensuremath{uF} \\
		\hline
	\end{tabular}
\end{table}

Für die Induktivität wurden vier AGP4233-153ME der Firma Coilcraft in reihe mit einer Gesamtinduktivität von 60 uH gewählt. Für die Kapazität zwei 22uF MLCC`s und ein 2,2mF Elko in Parallel der Firma Würth Elektronik.

Nun folgt die Berechnung der Fangschaltung bestehend aus Clamp Kondensator und einem RC Snubber.
