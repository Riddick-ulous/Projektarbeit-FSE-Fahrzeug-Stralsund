...
\begin{figure}[H]
	\centering
	\input{charts/cooling_system_chart.tex}
...
\\
\glsc{symb:deltaT_ein m} wird mit \ensuremath{30 K} angenommen. Die max. Temperatur des Kühlwassers sollte \ensuremath{60^\circ C} nicht überschreiten während im Hochsommer mit Umgebungstemperaturen von \ensuremath{30^\circ C} zu rechnen ist.\\
\\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\linewidth]{"bilder/ELW_Leistung über Volumenstrom"}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\linewidth]{"bilder/ELW-Druckabfall über Volumenstrom"}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\linewidth]{bilder/Kühlsystemkennlinie}
