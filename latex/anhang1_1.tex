...
Doppelklick auf das Symbol zum Öffnen. (Nur mit Adobe Acrobat)\\
\\
...
\attachfile[mimetype=application/vnd.ms-excel, icon=Paperclip]{calc/Kettenberechnung TY22.xlsx}

HVDCDC SPICE Simulation.asc
\attachfile[mimetype=plain/text, icon=Paperclip]{calc/HVDCDC_Full_startup_Cycle.asc}
