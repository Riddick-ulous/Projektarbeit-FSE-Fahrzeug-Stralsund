...
\newcommand{\themaderarbeit}{Entwicklung der Antriebs-Komponenten für ein elektrisches Formula Student Fahrzeug}
\newcommand{\jahrderabgabe}{2023}
\newcommand{\monatderabgabe}{02}
\newcommand{\tagderabgabe}{12}
...
\newcommand{\abstracteng}{This document contains informations about the development process for a diverse number of components that are used within an electric formula style car. The main objective is with the design of the high voltage electronics, but it also features information on the development of the cooling system for example. The background behind this work is the fact that the author was the first e-powertrain department leader at his local formula student team and aggregated a part of his work in+ this minor thesis.}
