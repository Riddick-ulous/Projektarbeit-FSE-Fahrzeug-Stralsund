...
\FloatBarrier
\section{Akkumulator}
Im Akkumulator befinden sich neben den Zellen in Ihren Zellstacks und dem \acfirst{AMS} auch diverse andere Systeme die zum Betrieb des Fahrzeuges essentiell sind. Diese Systeme werden im folgenden Kapitel erläutert. Bild \ref{fig:accumulator-layout} gibt eine Übersicht wo sich diese Systeme befinden und wie sie zusammenhängen.
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{bilder/2022-05-02-01-01-02-50704-st_hv_accuulator_rectangular_V10_for_EDR}
	\caption{Iso Ansicht Gesamtbaugruppe Akkumulator}
	\label{fig:2022-05-02-01-01-02-50704-sthvaccuulatorrectangularv10foredr}
\end{figure}
