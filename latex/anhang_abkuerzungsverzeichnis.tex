...
\begin{acronym}[Bash]
 %nutzung mit \ac{NAME}, bei erstem Gebrauch wird das Acronym automatisch ausgeschrieben	
	...
	\acro{NTU}{\markup{N}umber of \markup{T}ransfer \markup{U}nits}
	\acro{W2W}{\markup{W}ire \markup{t}o \markup{W}ire} 
	\acro{W2B}{\markup{W}ire \markup{t}o \markup{B}oard} 
	\acro{LAN}{\markup{L}ocal \markup{A}rea \markup{N}etwork} 
	\acro{Iso}{\markup{Iso}liert} 
	\acro{FCCM}{\markup{F}orced \markup{C}ontinuous \markup{C}onduction \markup{M}ode} 
	...
	\acro{DF}{\markup{D}issipation \markup{F}aktor}
	\acro{ESR}{\markup{E}quivalenter \markup{S}erieller \markup{W}iderstand}
	\acro{DCM}{\markup{D}iscontinuous \markup{C}onduction \markup{M}ode}
	\acro{CCM}{\markup{C}ontinuous \markup{C}onduction \markup{M}ode}
	...
	\acro{AMS}{\markup{A}kkumulator \markup{M}anagment \markup{S}ystem} 
